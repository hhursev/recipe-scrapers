...
If you are programmer PRs with fixes are warmly welcomed and acknowledged with a virtual beer. You can find documentation on how to develop scrapers `here <https://github.com/hhursev/recipe-scrapers/tree/developer-guide-docs/docs>`_.
...
- You are a developer and want to code the scraper on your own:
  ...
  - Generating a new scraper class:
    ...
    You can find a more detailed guide `here <https://github.com/hhursev/recipe-scrapers/blob/developer-guide-docs/docs/how-to-develop-scraper.md>`_.
