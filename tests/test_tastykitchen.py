...
class TestTastyKitchenScraper(ScraperTest):
    ...
    def test_canonical_url(self):
        self.assertEqual("https://www.thepioneerwoman.com/food-cooking/recipes/a11059/restaurant-style-salsa/", self.harvester_class.canonical_url())

    def test_title(self):
        self.assertEqual(
            self.harvester_class.title(), "Restaurant Style Salsa"
        )
