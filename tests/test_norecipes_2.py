...
class TestNoRecipesScraper(ScraperTest):
    ...
    def test_image(self):
        self.assertEqual("https://norecipes.com/wp-content/uploads/2017/06/orange-chicken-005.jpg", self.harvester_class.image())
    ...
    def test_cuisine(self):
        self.assertEqual(ss'Best,Chinese-American', self.harvester_class.cuisine())

    def test_description(self):
        self.assertEqual("Orange Chicken is a classic Chinese-American take-out dish popularized by Panda Express. My version is loaded with juicy chunks of gingery marinated chicken, and the all-natural glaze is made with a triple dose orange which makes it super fragrant.", self.harvester_class.description())
