...
class TestBiancaZapatkaScraper(ScraperTest):
    ...
    def test_image(self):
        self.assertEqual("https://biancazapatka.com/wp-content/uploads/2023/07/kuchen-blaubeeren-brombeeren.jpg", self.harvester_class.image())
    ...
    def test_description(self):
        self.assertEqual("This simple vegan blueberry cake is incredibly moist, fruity, super delicious and just like grandma used to make! You can turn this recipe into a loaf cake, round cake, bundt cake, sheet cake, or into small muffins and cupcakes!", self.harvester_class.description())
