...
class TestBigOven(ScraperTest):
    ...
    def test_title(self):
        self.assertEqual("White Chocolate Raspberry Cupcakes", self.harvester_class.title())
    ...
    def test_image(self):
        self.assertEqual("https://bigoven-res.cloudinary.com/image/upload/h_320,w_320,c_fill/white-chocolate-raspberry-cupc-bd2bf9.jpg", self.harvester_class.image())

    def test_ingredients(self):
        expected_ingredients = [
            '8 tablespoons Butter ; at room temp',
            '3/4 cup Sugar', '1 1/4 cups Flour',
