...
class TestNIHHealthyEatingRecipesScraper(ScraperTest):
  ...
  def test_host(self):
    self.assertEqual("healthyeating.nhlbi.nih.gov",
  ...
  def test_recipe_source(self):
    self.assertEqual("Delicious Heart Healthy Latino Recipes",
  ...
  def test_prep_time(self):
    self.assertEqual("10 minutes", self.harvester_class.prep_time())

  def test_cook_time(self):
    self.assertEqual("25 minutes", self.harvester_class.cook_time())
  ...
  def test_nutrients(self):
    self.assertCountEqual(
      [['calories', '265'], ['Total fat', '16 g'], ['Saturated fat', '2 g'],
       ['Cholesterol', '58 mg'], ['Sodium', '172 mg'], ['Total fiber', '3 g'],
       ['Protein', '22 g'], ['Carbohydrates', '9 g'], ['Potassium', '635 mg'],
