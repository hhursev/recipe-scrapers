...
class TestfattoincasadabenedettaScraper(ScraperTest):
    ...
    def test_category(self):
        self.assertEqual("Al cucchiaio,Alla frutta,Dolci,Torte,Torte fredde", self.harvester_class.category())
    ...
    def test_image(self):
        self.assertEqual("https://www.fattoincasadabenedetta.it/wp-content/uploads/2018/07/copertina-YT.jpg", self.harvester_class.image())

    def test_ingredients(self):
        expected_ingredients = [
            'limoni 4 il succo di 3 limoni per la crema e di 1 per la panna allo yogurt + fettine di limone q.b. per decorare',
            'zucchero 130 g', 'amido di mais 45 g', 'aroma limone 2 ml di cui 1 ml per la crema e 1 ml per la panna allo yogurt',
            'colorante giallo', 'limoncino 30 ml oppure succo di arancia o di limone', 'acqua 200 ml + q.b. per crema',
            'savoiardi 12', 'gelatina in fogli 10 g',
    ...
    def test_description(self):
        self.assertEqual("Un dessert estivo fresco e delicato, con una decorazione elegante e un sapore unico.", self.harvester_class.description())
