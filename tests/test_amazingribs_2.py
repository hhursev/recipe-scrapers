...
class TestAmazingRibsScraper(ScraperTest):
    ...
    def test_image(self):
        self.assertEqual("https://amazingribs.com/wp-content/uploads/2022/02/Screen-Shot-2022-02-08-at-12.38.59-PM.png", self.harvester_class.image())

    def test_ingredients(self):
        expected_ingredients = [
        "6 pound brisket point",
        "3 teaspoons Morton Coarse Kosher Salt ((approximately ½ teaspoon per pound))",
        "¼ cup Big Bad Beef Rub", "¼ cup Kansas City style barbecue sauce",
    ...
    def test_instructions(self):
        expected_instructions = [
            ...
            "When the meat's internal temperature reaches 155°F (68.3°C) and has taken on a nice dark hue, take the meat off of the smoker or grill and wrap it tightly in a double layer of heavy-duty foil. Add the beef broth, crimp the foil tight, and put the wrapped meat back on the smoker or grill over indirect heat. This step, called the Texas Crutch, slightly braises and steams the meat, but most importantly, it prevents the surface evaporation that cools down the meat and causes the stall (read more about the stall here).", "Prep again. When the meat temp hits 195°F (95°C), carefully remove it from the foil, reserving the liquid to use later. Cut the point into cubes about 1-inch on all sides. Set aside any pieces that are too fatty or just eat them. Dust them with rub and a little sugar to accelerate browning and bark formation. Tumble them onto a grill topper on a hot grill over direct heat for a few minutes to caramelize the sugars and brown the cut edges.", "Cook again. In a frying pan, render the beef fat that you trimmed from the brisket point. Or better still, use bacon fat or duck fat. You can do this over hot coals. Move the cubes to the pan and gently fry them until they are crunchy on the outside, turning them a few times. Drain the fat and add about 1/4 cup of your favorite BBQ sauce and 1/4 cup of the drippings from the foil used for the Texas Crutch. Put the pan back on the grill and stir every 5 minutes or so. Let the cubes absorb most of the liquid and start to sizzle, but don't let them burn.",
