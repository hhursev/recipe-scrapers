...
class TestBlueJeanChefScraper(ScraperTest):
    ...
    def test_image(self):
        self.assertEqual("https://bluejeanchef.com/uploads/2023/07/No-Bake-Cheesecake-1280-9439.jpg", self.harvester_class.image())
    ...
    def test_description(self):
        self.assertEqual("No oven needed for this no bake layered cheesecake! Layer blueberry, plain and raspberry cheesecake batters on top of each other and chill well for a delightfully refreshing summer dessert.", self.harvester_class.description())
