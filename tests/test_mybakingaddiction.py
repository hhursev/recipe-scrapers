...
class TestMyBakingAddictionScraper(AbstractTest.ScraperTest):
    ...
    def test_image(self):
        self.assertEqual(
            "https://www.mybakingaddiction.com/wp-content/uploads/2016/08/slice-from-chocolate-zucchini-loaf-hero-720x720.jpg",
