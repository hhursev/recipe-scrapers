...
class TestMatprat(unittest.TestCase):
    def setUp(self):
        ...
        with open(os.path.join(
            ...
            self.harvester_class = Matprat(file_opened, test=True)
    ...
    def test_title(self):
        self.assertEqual(
            ...
            'Butter chicken - indisk smørkylling'
        )
    ...
    def test_ingredients(self):
        self.assertCountEqual(
            ['1 stk kylling (ca. 1300 g)', '4 båter hvitløk', '½ ss revet frisk ingefær', '2 ss sitronsaft', '--- Marinade ---', '1 dl gresk yoghurt', '½ ss chilipulver (helst indisk)', '1 ss garam masala', '1 ss rapsolje eller sennepsolje', '--- Smør- og tomatcurry ---', '100 g cashewnøtter',
             '8 stk tomat', '2 ss olje', '4 båter finhakket hvitløk', '½ ss revet frisk ingefær', '½ ss chilipulver (helst indisk)', '2 stk hel kardemomme', '2 ts hel bukkehornkløver', '2 ss flytende honning', '1 stk grønn chili', '2 ss smør', '1 dl fløte', '½ potte frisk koriander'],
