...
class TestRezeptweltScraper(ScraperTest):
    ...
    def test_instructions(self):
        expected = 'Salat1. Wasser und Gemüsebrühe in den Mixtopf geben und 8Min./100°/Stufe 1 aufkochen2. Nudeln zugeben, je nach Packungsanweisung ca. 8-10Min./100°/"Linkslauf" /Stufe "Sanftrührstufe" garen, Nudeln in den Gareinsatz abgießen und Garflüssigkeit dabei auffangen. Nudeln in eine große Schüssel umfüllen und etwas abkühlen lassen.3. getrocknete Tomaten in den Mixtopf geben, 5Sek./"Linkslauf deaktiviert" /Stufe 4 zerkleinern und zu den Nudeln geben.4.Mozarella in den Mixtopf geben, 2 Sek./Stufe 4 zerkleinern und zu den Nudeln geben.5. Alle weiteren Salatzutaten (Rucola, schwarze Oliven und Kirschtomaten) in die große Schüssel zugeben und vermischenDressing:6. Knoblauch und Basilikum in den Mixtopf geben 4 Sek./Stufe 7 zerkleinern.7. Übrige Zutaten und 120 g Garflüssigkeit zugeben und 15Sek./Stufe 3-4 verrühren, zum Salat geben und vermischen.\n'
