...
class TestGonnaWantSeconds(unittest.TestCase):
    def setUp(self):
        ...
        with open(os.path.join(
            ...
            'test_data',
            'gonnawantseconds.testhtml'
        )) as file_opened:
            self.harvester_class = GonnaWantSeconds(file_opened, test=True)
    ...
    def test_ingredients(self):
        self.assertCountEqual(
            [
                'Filling:', '2 tablespoons vegetable oil', '1 cup onion, diced', '1 package taco seasoning', '1 (10-ounce) can Rotel, drained', '1/2 teaspoon salt', '1/2 teaspoon black pepper', '2 cups cooked chicken, shredded', '1/2 cups sour cream', '1 cups Monterey jack cheese, shredded', '10 (8-inch) flour tortillas', 'Sauce:', '3 tablespoons butter', '3 tablespoons all-purpose flour', '2 cups chicken broth', '1 cup sour cream', '1 (4-ounce) can chopped green chiles, drained', 'Topping:', '2 cups Monterey jack cheese, shredded', 'Garnish (optional): ', '2 tablespoons chopped cilantro or green onions'
            ],
    ...
    def test_instructions(self):
        return self.assertEqual(
            ['Preheat oven to 350 degrees. Spray a 9X13 inch baking dish with nonstick cooking spray; set aside', 'Make Filling and Roll:', "Add oil to a large skillet and saute onion until it's translucent and soft. Add taco seasoning, salt, pepper, and Rotel and stir to combine. Add shredded chicken and toss to evenly coat with onion and seasoning mixture. Remove from the heat, cover, and set aside.\nIn a medium bowl, stir together 1 cup Monterey Jack and 1/2 cup sour cream until evenly combined.\nFill tortillas with a layer of the chicken mixture then a layer of the cheese mixture and roll each one and place seam side down, in the prepared pan.", 'Make Sauce:',
