...
class TestEmmiKochtEinfachScraper(ScraperTest):
    ...
    def test_title(self):
        self.assertEqual('Klassisches Rindergulasch ganz einfach', self.harvester_class.title())
    ...
    def test_image(self):
        self.assertEqual('https://emmikochteinfach.de/wp-content/uploads/2022/02/seo_Gulasch-Nah-200.jpg',
    ...
    def test_ingredients(self):
        self.assertCountEqual(
            ['600 g Rindergulasch (ca. 3x3 cm große Stücke, gegebenenfalls selbst kleiner schneiden)',
             ...
             '40 g Tomatenmark', '3 EL Butterschmalz (z.B. Buttaris; Alternativ Pflanzenöl )',
             '1 Knoblauchzehe (geschält, klein geschnitten)',
             '1-2 TL Zitronenabrieb (unbehandelt bzw. Bio) (kannst Du auch weggelassen )',
             '2 TL Paprikapulver, edelsüß', '1/2 TL Majoran, getrocknet', '1 Msp. Cayennepfeffer',
             '1 Prise Salz',
...
Ich wünsche Dir einen guten Appetit! Lass Dir mein klassisches Rindergulasch Rezept gut schmecken.
        """.strip(), self.harvester_class.instructions())

    def test_ratings(self):
        self.assertEqual(4.99, self.harvester_class.ratings())

    def test_description(self):
        self.assertEqual('Mein Familienrezept ist ein echter Klassiker. Gulasch kochen geht einfacher als man denkt. Mit zartem Fleisch, leckeren Röstaromen und einer sämigen Soße wird es auch Dir gelingen.', self.harvester_class.description())
