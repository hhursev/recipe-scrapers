...
class TestOnceUponAChefScraper(ScraperTest):
    ...
    def test_title(self):
        self.assertEqual('Black Bean & Corn Salad with Chipotle-Honey Vinaigrette', self.harvester_class.title())
    ...
    def test_image(self):
        self.assertEqual('https://www.onceuponachef.com/images/2014/06/Black-Bean-and-Corn-Salad.jpg', self.harvester_class.image())
