...
class TestChefkochScraper(ScraperTest):
    ...
    def test_description(self):
        self.assertEqual(
            ...
            "Hackbraten supersaftig - klassischer saftiger Hackbraten mit viel Soße. Über 1427 Bewertungen und für lecker befunden. Mit ► Portionsrechner ► Kochbuch ► Video-Tipps!",
        )
