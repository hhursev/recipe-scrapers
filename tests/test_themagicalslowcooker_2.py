...
class TestTheMagicalSlowCookerScraper(ScraperTest):
    ...
    def test_title(self):
        self.assertEqual("Slow Cooker Pork Roast with Gravy", self.harvester_class.title())
    ...
    def test_image(self):
        self.assertEqual("https://www.themagicalslowcooker.com/wp-content/uploads/2023/02/crockpot-pork-pot-roast-4.jpg", self.harvester_class.image())

    def test_ingredients(self):
        self.assertEqual(['4 lbs. boneless pork shoulder', 
                          '¼ cup brown sugar', 
                          '1 tsp. onion powder', 
                          '1 tsp. garlic powder', 
    ...
    def test_description(self):
        self.assertEqual("Pork is so flavorful; why not make a pot roast dinner with it?! The recipe has everything you need from the meat, vegetables and even the gravy.", self.harvester_class.description())
