...
class TestCostcoScraper(ScraperTest):
    ...
    def test_instructions(self):
        instructions_text = "/nCombine chicken, grapes, celery, walnuts and blue cheese in a large mixing bowl./nIn a medium-size mixing bowl, blend mayonnaise, sherry vinegar, thyme, lemon zest, garlic powder and salt./nFold the dressing into the chicken-grape mixture and combine well. Adjust seasonings as desired. Serve in Bibb lettuce cups or as a sandwich filling. Makes 6 servings."
