...
class TestErrensKitchenScraper(ScraperTest):
    ...
    def test_description(self):
        self.assertEqual('A delectable dish of Creamy Sun-Dried Tomato Pasta with Chicken flavored with Parmesan cheese, sun-dried tomatoes, onions, and garlic.', self.harvester_class.description())

    def test_image(self):
        self.assertEqual('https://www.errenskitchen.com/wp-content/uploads/2022/05/Chicken-Sundried-Tomato-Pasta-06.jpg', self.harvester_class.image())

    def test_ratings(self):
        self.assertEqual(5.0, self.harvester_class.ratings())

    def test_title(self):
        self.assertEqual('Creamy Sun-Dried Tomato Pasta with Chicken', self.harvester_class.title())
