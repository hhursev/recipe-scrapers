...
class TestFoodFidelity(ScraperTest):
    ...
    def test_ingredients(self):
        self.assertEqual(
            [
                "1 cup water",
                "2/3 cupÂ orange juice",
                "1 1/3Â cupsÂ pearl couscous",
                "1 cups sliced red onion",
                "1 cloveÂ garlic",
                "3 TbspÂ white sugar",
                "1Â TbspÂ salt",
                "1/2Â tspÂ peppercorns",
                "1Â cupÂ white vinegar",
                "1 poundÂ asparagusÂ trimmed",
                "3Â tablespoonsÂ extra-virgin olive oil",
                "Kosher salt and freshly ground black pepper",
                "1 lemon",
                "1Â cup white wine",
                "1Â cup dried cranberries",
            ],
