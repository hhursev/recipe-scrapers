...
class TastingHistory(AbstractScraper):
    ...
    def ingredients(self):
        ingredients = []
        ingredients_lists = self.soup.select("div.sqs-col-4.span-4 .sqs-block-content ul")
    ...
    def instructions(self):
        instructions = []
        instructions_list = self.soup.select_one("div.sqs-col-8.span-8 .sqs-block-content ol")
