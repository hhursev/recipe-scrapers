...
class Dr(AbstractScraper):
    ...
    def author(self):
        author_div = self.soup.find('div', {'class': 'dre-byline__contribution-details'})
        author_span = author_div.find('span', {'itemprop': 'name'}) if author_div else None
    ...
    def instructions(self):
        ...
        if fremgangsmade_div:
            ...
            if parent_section:
                instructions_list = []
                instructions_divs = parent_section.findAll('div', {'class': 'dre-speech'})
