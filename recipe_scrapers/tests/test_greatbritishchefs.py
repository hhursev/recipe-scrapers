...
class TestGreatBritishChefsScraper(unittest.TestCase):
    ...
    def test_ingredients(self):
        self.assertCountEqual(
            [
                'Picadillo', '500g of beef mince', '1 onion, diced', '2 garlic cloves, sliced', '1 carrot, finely diced', '1 potato, finely diced', '1 bay leaf', '1 tsp ground cumin', '1 tsp ground coriander', '1 tsp smoked paprika', '2 tbsp of tomato purée', '100g of raisins', '300ml of chicken stock', '300g of tomatillo salsa', '1 tsp honey', 'lime juice, to taste', '1 handful of coriander, chopped', 'salt, to taste', 'olive oil'],
