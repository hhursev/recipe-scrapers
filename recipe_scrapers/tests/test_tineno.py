...
class TestTineNoScraper(unittest.TestCase):
    ...
    def test_ingredients(self):
        self.assertCountEqual(
            [
                'Ris:', '4 dl basmatiris', 'Tikka masala:', '400 g kyllingfileter', '1 ss TINE Meierismørtil steking', '1 stk paprika', '½ dl chili', '3 stk vårløk', '1 ts hvitløksfedd', '1 ss hakket, friskingefær', '½ dl hakket, friskkoriander', '2 ts garam masala', '3 dl TINE Lett Crème Fraîche 18 %', '3 ss tomatpuré', '½ ts salt', '¼ ts pepper', 'Raita:', '½ dl slangeagurk', '3 dl TINE Yoghurt Naturell', '½ dl friskmynte', '1 ts hvitløksfedd', '½ ts salt', '¼ ts pepper'
            ],
