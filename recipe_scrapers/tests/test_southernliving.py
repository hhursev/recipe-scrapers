...
class TestSouthernLiving(unittest.TestCase):
    def setUp(self):
        # tests are run from tests.py
        with open(os.path.join(
            os.path.dirname(os.path.realpath(__file__)),
            'test_data',
            'southernliving.testhtml'
        )) as file_opened:
            self.harvester_class = SouthernLiving(file_opened, test=True)
    ...
    def test_title(self):
        self.assertEqual(
            ...
            'Spicy Sausage-and-Cheddar Kolaches Recipe'
        )
    ...
    def test_ingredients(self):
        self.assertCountEqual(
            [
                '1 cup whole milk', '3/4 cup salted butter, divided', '1/2 cup warm water (100°F to 110°F)', '1 (1⁄4-oz.) envelope active dry yeast', '1/3 cup plus 1 tsp. granulated sugar, divided', '2  large eggs, beaten', '3/4 teaspoon salt', '5 1/4 - 6 cups bread flour, divided, plus more for dusting', '1 1/4 pounds Conecuh sausage or spicy smoked sausage', '4 ounces sharp Cheddar cheese, shredded (about 1 cup)'
            ],
